---
# 这是 var_9930d615 经 promote 后注册到 registry 的 ticket_summary_zh@1.3.0
# 内容与 variants/var_9930d615/SKILL.md **逐字相同**（promotion 不修改内容）
# 这里冗余存放是为了让本样例自包含，便于读者直接看"最终落地版本"
...
labels:
  team: "service-desk"
  promoted_from_iteration: "itr_01K2B0BRYN8P8R5H2YJ7M9E7N0"
  promoted_from_variant: "var_9930d615"
